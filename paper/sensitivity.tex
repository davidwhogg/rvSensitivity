...
Now how do we use this $2\times 2$ mean precision matrix $\mean{\tC_\theta\inv}$?

HOGG WORDS HERE

\paragraph{Discussion and implementation notes:}
This solution assumed a very large number of things. We will discuss these
below in \sectionname~\ref{sec:discussion}.

Don't explicitly make $\tC_v\inv$.

Use solve not inv.

What happens if you expect covariant noise?
