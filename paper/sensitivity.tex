...
is the inverse\footnote{CITE Albrecht here, and also note that you
  shouldn't invert in general, but in low-d problems like this it is
  fine. In this problem, you would have to be careful if you had only
  ...
  have to do something zero-safe. HOGG DO WE RETURN TO THIS ISSUE BELOW?}
of the precision matrix $\tC_\theta\inv$.
